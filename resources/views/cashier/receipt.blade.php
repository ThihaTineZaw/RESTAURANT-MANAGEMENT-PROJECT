...
<!-- Action Buttons -->
<div class="no-print">
    <a href="{{ route('cashier.index') }}" class="btn-back">← Back to Cashier</a>
    <button class="btn-print" onclick="window.print()">
        <svg style="width: 16px; height: 16px; display: inline-block; vertical-align: middle; margin-right: 6px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 0 00-2 2v4h10z"></path>
        </svg>
        Print Receipt
    </button>
</div>
